...
object AgeModelTest5 {
 ...
 val music = sc.textFile("hdfs://mz-hadoop-1.meizu.com:9000/user/hadoop/xuhong/data/age_model/music/20150429/dim_music_singer/*").cache()
 val ret_music = sc.textFile("hdfs://mz-hadoop-1.meizu.com:9000/zhouxiaoke/age/music/03/*").cache()
        ...
        val data=   data_music_data2.map {
          ...
          line2 =>
            ...
            if(data_music_data6.contains(data_music_data3)){
              ...
              data_music_data3 = (50000+ data_music_data6(data_music_data3)).toString
    ...
    result2.saveAsTextFile("hdfs://mz-hadoop-1.meizu.com:9000/zhouxiaoke/age/music/04/")
  ...
  def data_deal_music(music: RDD[String]) = {
    ...
    music.map {
      line =>
        ...
        ("33" + data_music(0) + "," + data_music(1) + "," + data_music(2))
    }
