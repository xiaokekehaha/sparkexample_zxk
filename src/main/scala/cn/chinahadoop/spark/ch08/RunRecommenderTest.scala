...
object RunRecommenderTest {
  ...
  def areaUnderCurve(
    ...
    val positivePredictions = predictFunction(positiveUserProducts).groupBy(_.user)
     ...
     val negativeUserProducts2 =  predictFunction(positiveUserProducts)
    ...
    val data=positivePredictions.join(negativePredictions)
  ...
  def evaluate(
    ...
    //val data2=predictMostListened(sc, trainData)()
