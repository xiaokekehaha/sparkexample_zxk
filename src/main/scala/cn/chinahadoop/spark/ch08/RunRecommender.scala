    ...
    val negativeUserProducts = positiveUserProducts.groupByKey().mapPartitions {
      ...
      userIDAndPosItemIDs => {
        ...
        userIDAndPosItemIDs.map { case (userID, posItemIDs) =>
          ...
          val data= negative.map(itemID => (userID, itemID))
          //val negativeUserProducts: org.apache.spark.rdd.RDD[scala.collection.mutable.ArrayBuffer[(Int, Int)]]
          //val negativeUserProducts: org.apache.spark.rdd.RDD[(Int, Int)]
